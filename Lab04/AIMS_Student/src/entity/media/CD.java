...
//    }
    ...
    public CD(int id, String title, String category, int price, int quantity, boolean rushSupported, String artist,
            String recordLabel, String musicType, Date releasedDate) throws SQLException{
...
//                          artist, recordLabel, musicType, releasedDate);
            return new CD(id, title, category, price, quantity, rushSupported, 
                    artist, recordLabel, musicType, releasedDate);
