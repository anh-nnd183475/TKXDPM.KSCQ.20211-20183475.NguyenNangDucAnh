...
//    }
    ...
    public DVD(int id, String title, String category, int price, int quantity, boolean rushSupported, String discType,
            String director, int runtime, String studio, String subtitles, Date releasedDate, String filmType) throws SQLException{
        super(id, title, category, price, quantity, rushSupported);
        this.discType = discType;
        this.director = director;
        this.runtime = runtime;
        this.studio = studio;
...
//        String type = res.getString("type");
        boolean rushSupported = res.getBoolean("rushSupported");
...
//        return new DVD(id, title, category, price, quantity, type, discType, director, runtime, studio, subtitles, releasedDate, filmType);
        return new DVD(id, title, category, price, quantity, rushSupported, discType, director, runtime, studio, subtitles, releasedDate, filmType);
